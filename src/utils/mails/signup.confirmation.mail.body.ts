export const SignupConfirmationMailBody = (defaultPass: string, firstname: string) => `<body
    style="
      width: 100%;
                                ...
                                <tr>
                                  ...
                                  >
                                    ...
                                    <p
                                      ...
                                      "
                                    >
                                      Thank you for signing up with PAWA, your default Login password is :
                                    <br/>
                                      </p>
                                    <br/>
                                    <br/>
                                    ...
                                    <p
                                      ...
                                      "
                                    >
                                      Please make sure you change the default password as soon as you login. 
                                    <br/>
                                      </p>
                                    <br/>
