...
export class AddNewClientDto {
  ...
  @Length(2, 200, {
    message:
      "The home address length must be between 2 and 200 characters long.",
    context: {
      code: ClientsErrorCodes.validate.homeAddress,
    },
  })
  ...
  @Length(0, 200, {
    message:
      "The business address length must be between 2 and 200 characters long.",
    context: {
      code: ClientsErrorCodes.validate.businessAddress,
    },
  })
  ...
  @Length(2, 20, {
    message:
      "The mobile number length must be between 2 and 20 characters long.",
    context: {
  ...
  @Length(0, 20, {
    message:
      "The office phone length must be between 2 and 20 characters long.",
    context: {
