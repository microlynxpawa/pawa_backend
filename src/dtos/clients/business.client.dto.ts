...
export class AddNewBusinesslientDto {
  ...
  @Length(1, 100, {
    message:
      "The client name length must be between 1 and 100 characters long.",
    context: {
      code: BusinessClientsErrorCodes.validate.clientName,
    },
  })
  ...
  @Length(2, 200, {
    message:
      "The registered address length must be between 2 and 200 characters long.",
    context: {
      code: BusinessClientsErrorCodes.validate.registeredAddress,
    },
  })
  ...
  @Length(0, 200, {
    message:
      "The office address length must be between 2 and 200 characters long.",
    context: {
      code: BusinessClientsErrorCodes.validate.officeAddress,
    },
  })
  ...
  @Length(2, 20, {
    message:
      "The office phone number length must be between 2 and 20 characters long.",
    context: {
  ...
  @Length(0, 20, {
    message:
      "The office phone 2 length must be between 2 and 20 characters long.",
    context: {
